    ...
    <main style={{
      ...
      <div style={{ maxWidth: 720, margin: "0 auto", padding: "56px 24px 0" }}>
        ...
        <div style={{ padding: "24px", borderRadius: 14, border: "1px solid rgba(255,255,255,0.08)", background: "rgba(255,255,255,0.02)", marginTop: 24 }}>
          <p style={{ ...P, margin: 0 }}>Questions? Email us at <a href="mailto:legal@dominat8.io" style={{ color: "rgba(124,90,255,0.75)", textDecoration: "none", fontWeight: 600 }}>legal@dominat8.io</a></p>
        </div>
      </div>
    </main>
  );
