...
export default function GalleryPage() {
  return (
    <main style={{
      ...
      {/* Nav */}
      <nav style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "18px 32px", borderBottom: "1px solid rgba(255,255,255,0.06)", position: "sticky", top: 0, zIndex: 50, background: "rgba(8,8,12,0.80)", backdropFilter: "blur(20px)" }}>
        ...
        <div style={{ display: "flex", gap: 8 }}>
          ...
          <a href="/" style={{ padding: "8px 16px", borderRadius: 999, background: "linear-gradient(135deg,#7C5AFF,#6347FF)", color: "#fff", textDecoration: "none", fontSize: 13, fontWeight: 700, boxShadow: "0 2px 10px rgba(124,90,255,0.30)" }}>Start building →</a>
        </div>
      </nav>
      ...
      <div style={{ textAlign: "center", padding: "64px 24px 0", position: "relative", zIndex: 1 }}>
        <div style={{ maxWidth: 480, margin: "0 auto" }}>
          ...
          <a href="/" style={{ display: "inline-block", padding: "14px 36px", borderRadius: 14, background: "linear-gradient(135deg,#7C5AFF,#6347FF)", color: "#fff", textDecoration: "none", fontSize: 15, fontWeight: 800, boxShadow: "0 4px 24px rgba(124,90,255,0.40)", letterSpacing: "-0.01em" }}>
