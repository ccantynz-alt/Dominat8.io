...
export default function GalleryPage() {
  return (
    <main style={{
      ...
      background: "#06080e",
      color: "#e9eef7",
      fontFamily: "var(--d8-font, 'Outfit'), ui-sans-serif,system-ui,-apple-system,sans-serif",
      padding: "0 0 80px",
    }}>
      ...
      {/* Hero */}
      <div style={{ textAlign: "center", padding: "120px 24px 48px", position: "relative", zIndex: 1 }}>
      ...
      <div style={{ textAlign: "center", padding: "64px 24px 0", position: "relative", zIndex: 1 }}>
        <div style={{ maxWidth: 480, margin: "0 auto" }}>
          ...
          <a href="/build" style={{ display: "inline-block", padding: "14px 36px", borderRadius: 14, background: "rgba(61,240,255,0.14)", border: "1px solid rgba(61,240,255,0.40)", color: "rgba(61,240,255,0.95)", textDecoration: "none", fontSize: 15, fontWeight: 800, letterSpacing: "-0.01em" }}>
