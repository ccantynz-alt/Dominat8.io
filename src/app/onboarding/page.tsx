    ...
    <>
      <style>{`
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .ob-logo span { color: #7C5AFF; }
        .ob-card { width: 100%; max-width: 560px; }
        .ob-step { font-size: 11px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.08em; color: rgba(124,90,255,0.70); margin-bottom: 12px; }
        ...
        .ob-chip:hover { border-color: rgba(124,90,255,0.35); background: rgba(124,90,255,0.06); color: #fff; }
        .ob-chip.selected { border-color: rgba(124,90,255,0.60); background: rgba(124,90,255,0.12); color: rgba(124,90,255,0.95); }
        .ob-chip-icon { font-size: 22px; }
        .ob-btn { width: 100%; padding: 15px; border-radius: 12px; background: linear-gradient(135deg, rgba(124,90,255,0.20), rgba(80,70,228,0.20)); border: 1px solid rgba(124,90,255,0.45); color: rgba(124,90,255,0.97); font-size: 16px; font-weight: 700; cursor: pointer; font-family: inherit; transition: all 150ms; letter-spacing: -0.01em; }
        .ob-btn:hover { background: linear-gradient(135deg, rgba(124,90,255,0.28), rgba(80,70,228,0.28)); transform: translateY(-1px); }
        ...
        .ob-dot.active { background: rgba(124,90,255,0.70); }
      `}</style>
