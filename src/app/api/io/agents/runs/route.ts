...
function mockRuns(): AgentRun[] {
  ...
  return [
    { id: "run_" + (now - 120000).toString(36), agent: "SEO-V2", status: "succeeded",
      ...
      summary: "Updated titles and generated keywords." },
    ...
    { id: "run_" + (now - 30000).toString(36), agent: "CONTENT", status: "running",
      ...
      summary: "Drafting landing pages and internal links." },
...
export async function GET(req: Request) {
  ...
  return NextResponse.json(
    { ok: true, patch: "IO_ROCKET_COCKPIT_v1_20260131", at: new Date().toISOString(), ts, runs },
    { headers: { "cache-control": "no-store", "x-d8io-patch": "IO_ROCKET_COCKPIT_v1_20260131", "x-d8io-surface": "rocket-cockpit", "x-d8io-count": String(runs.length) } }
  );
}