...
export default async function PublicProjectPage({ params }: Props) {
    ...
    return (
      <main style={{ padding: 24, fontFamily: "ui-sans-serif, system-ui" }}>
        ...
        <p style={{ marginTop: 12, color: "#555" }}>
          Go back to the builder and click Publish.
        </p>
      </main>
    );
  }
  ...
  const ctaText = hero?.ctaText ?? "Start free";
    ...
    <main style={{ minHeight: "100vh", background: "white", fontFamily: "ui-sans-serif, system-ui" }}>
      <header style={{ padding: "28px 24px", borderBottom: "1px solid #eee" }}>
        <div style={{ maxWidth: 980, margin: "0 auto", display: "flex", justifyContent: "space-between", gap: 16 }}>
          ...
          <nav style={{ display: "flex", gap: 14, fontSize: 14 }}>
            <a href={ctaHref} style={{ textDecoration: "underline" }}>Start</a>
          </nav>
        </div>
      </header>
      ...
      <section style={{ padding: "64px 24px" }}>
        <div style={{ maxWidth: 980, margin: "0 auto" }}>
          <h1 style={{ fontSize: 46, lineHeight: 1.1, fontWeight: 950, margin: 0 }}>{headline}</h1>
      ...
      <section style={{ padding: "0 24px 72px" }}>
        <div style={{ maxWidth: 980, margin: "0 auto" }}>
          <h2 style={{ fontSize: 22, fontWeight: 900, marginBottom: 14 }}>Features</h2>
