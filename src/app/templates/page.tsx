    ...
    <main style={{
        ...
        {CATEGORIES.map(cat => (
          <button
            ...
            style={{
              padding: "7px 16px",
              borderRadius: 999,
              border: `1px solid ${active === cat ? "rgba(124,90,255,0.40)" : "rgba(255,255,255,0.10)"}`,
              background: active === cat ? "rgba(124,90,255,0.10)" : "rgba(255,255,255,0.03)",
              color: active === cat ? "rgba(124,90,255,0.95)" : "rgba(255,255,255,0.55)",
              fontSize: 13,
      ...
      {filtered.length === 0 && (
        <div style={{ textAlign: "center", padding: "60px 24px", color: "rgba(255,255,255,0.30)", fontSize: 15 }}>
          No templates match your search. <button onClick={() => { setSearch(""); setActive("All"); }} style={{ background: "none", border: "none", color: "rgba(124,90,255,0.70)", cursor: "pointer", fontSize: 15 }}>Clear filters</button>
        </div>
      )}
