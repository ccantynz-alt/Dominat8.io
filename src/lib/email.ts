...
<body style="background:#08070B;color:#F5F0EB;font-family:'Outfit',system-ui,sans-serif;margin:0;padding:40px 24px">
  <div style="max-width:520px;margin:0 auto">
    <div style="font-size:24px;font-weight:900;letter-spacing:-0.03em;margin-bottom:32px">
      Dominat8<span style="color:#F0B35A">.io</span>
    </div>
    ...
    <a href="${APP_URL}/build" style="display:inline-block;padding:14px 32px;border-radius:12px;background:linear-gradient(135deg,rgba(240,179,90,0.25),rgba(232,113,90,0.25));border:1px solid rgba(240,179,90,0.45);color:rgba(240,179,90,0.97);text-decoration:none;font-weight:700;font-size:16px;letter-spacing:-0.01em">
...
<body style="background:#08070B;color:#F5F0EB;font-family:'Outfit',system-ui,sans-serif;margin:0;padding:40px 24px">
  <div style="max-width:520px;margin:0 auto">
    ...
    <a href="${APP_URL}/build" style="display:inline-block;padding:14px 32px;border-radius:12px;background:linear-gradient(135deg,rgba(240,179,90,0.25),rgba(232,113,90,0.25));border:1px solid rgba(240,179,90,0.45);color:rgba(240,179,90,0.97);text-decoration:none;font-weight:700;font-size:16px">
      Start building →
    </a>
    <p style="color:rgba(255,255,255,0.25);font-size:12px;margin-top:48px">
      Dominat8.io · <a href="${APP_URL}/unsubscribe" style="color:rgba(255,255,255,0.25)">Unsubscribe</a>
...
<body style="background:#08070B;color:#F5F0EB;font-family:system-ui,sans-serif;margin:0;padding:40px 24px">
  <div style="max-width:520px;margin:0 auto">
    <div style="font-size:24px;font-weight:900;margin-bottom:32px">Dominat8<span style="color:#F0B35A">.io</span></div>
    ...
    <a href="${APP_URL}/pricing" style="display:inline-block;padding:14px 32px;border-radius:12px;background:rgba(240,179,90,0.15);border:1px solid rgba(240,179,90,0.40);color:rgba(240,179,90,0.97);text-decoration:none;font-weight:700;font-size:16px">
