...
export default function IOTVShell() {
  const stamp = "IO_TV_SHELL_LOCKED_20260204";
  return (
    <main
      style={{
        minHeight: "100vh",
      ...
      >
        ...
        <div style={{ padding: 22, paddingTop: 6 }}>
          ...
          <p style={{ marginTop: 10, marginBottom: 0, opacity: 0.82, fontSize: 16, lineHeight: 1.5 }}>
            This is the safe TV shell. dominat8.io is hard-locked to it by host-truth middleware.
            Marketing will never render on .io.
          </p>
          ...
          <div style={{ marginTop: 18, display: "grid", gridTemplateColumns: "repeat(3, minmax(0, 1fr))", gap: 12 }}>
            ...
            <Card title="Build Safety" body="Client TV code cannot take builds down." />
            <Card title="Automation Ready" body="Repair owner loop can safely iterate underneath." />
          </div>
