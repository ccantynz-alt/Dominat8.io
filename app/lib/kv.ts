...
/**
 * Typed KV helpers so you don’t repeat JSON parsing everywhere.
 * Vercel KV already serializes objects, but we keep helpers for clarity.
 */
export const KV = {
  get: kv.get.bind(kv),
  set: kv.set.bind(kv),
  ...
  /**
   * Small helper to reduce footguns when something is missing.
   */
